...
class vplayer extends StatefulWidget {
  ...
  vplayer({Key? key, required this.source}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Container(
          height: 50, // Set a proper height for the container
            ...
            children: [
              FloatingActionButton(
                ...
                onPressed: () async {
                  ...
                  if (filePath != null) {
                    _controller1.pause();
                    _controller1 = VideoPlayerController.file(File(filePath));
                    _controller1.addListener(() {
                      setState(() {});
                    });
